...
public class TensorFlowSignDetectionAPIModel implements Classifier{
    ...
    public static Classifier create(
        ...
        final TensorFlowSignDetectionAPIModel d = new TensorFlowSignDetectionAPIModel();
    ...
    private TensorFlowSignDetectionAPIModel() {}
    ...
    public List<Recognition> recognizeImage(Bitmap bitmap) {
        ...
        for (int i = 0; i < outputScores.length; ++i) {
            ...
            String label = labels.get((int) outputClasses[i]);
                pq.add(
                        new Recognition("" + i, label , outputScores[i], detection, false));
            }
