...
public class DetectorActivity extends CameraActivity implements OnImageAvailableListener {
  ...
  private long lastLaneProcessingTimeMs;
  private Bitmap rgbFrameBitmap = null;
  private Bitmap croppedBitmap = null;
  private Bitmap cropCopyBitmap = null;

  private Bitmap laneBitmap = null;
    ...
    addCallback(
        new DrawCallback() {
          ...
          public void drawCallback(final Canvas canvas) {
            ...
            /*MmM try here*/
              //final Bitmap  lanecopy =   laneMatcher.detectLane(copy);
            ...
            lines.add("Lane matcher time: " + lastLaneProcessingTimeMs + "ms");
  ...
  protected void processImage() {
    ...
    runInBackground(new Runnable() {
      @Override
      public void run() {
        LOGGER.i("Running lane matcher on image " + currTimestamp);
        final long startTime = SystemClock.uptimeMillis();

        laneBitmap = laneMatcher.detectLane(rgbFrameBitmap);

        lastLaneProcessingTimeMs = SystemClock.uptimeMillis() - startTime; //check usage
      }
    });
    ...
    runInBackground(
        new Runnable() {
          ...
          public void run() {
            ...
            /*MmM dangerous paint*/
            final Paint dangerousPaint = new Paint();
            dangerousPaint.setColor(Color.RED);
            dangerousPaint.setStyle(Style.STROKE);
            dangerousPaint.setStrokeWidth(3.0f);
